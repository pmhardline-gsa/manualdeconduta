...
<iframe src="hierarquia.html" width="100%" height="1080px" style="border: none; background: transparent;"></iframe>

---

<p style="text-align: center; color: #f1c40f; font-family: 'Courier New', monospace; font-size: 1.2em; font-weight: bold; font-style: italic;">
  <em><strong>"Vigilância implacável, precisão cirúrgica. Acima de nós, apenas a ordem."</strong></em>
</p>
